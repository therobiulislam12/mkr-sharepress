        ...
        <div class="sspp-icons-wrapper">
			...
			<?php if ( in_array( 'facebook', $permitted_links ) ) { ?>
                <a class="icon skype" href="https://web.skype.com/share?url=<?php echo esc_url( get_the_permalink() ) ?>" target="_blank" onclick="return openPopup(this.href)">
                    <div class="bg-ico" id="skype"><i class="fab fa-skype social  skype fa-3x"></i></div>
                </a>
			<?php } ?>
			...
			<?php if ( in_array( 'facebook', $permitted_links ) ) { ?>
                <a class="icon linkedin" href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo esc_url( get_the_permalink() ) ?>" target="_blank" onclick="return openPopup(this.href)">
                    <div class="bg-ico" id="linkedin"><i class="fab fa-linkedin social  linkedin fa-3x"></i></div>
                </a>
			<?php } ?>
			...
			<?php if ( in_array( 'facebook', $permitted_links ) ) { ?>
                <a class="icon envelope" href="mailto:?subject=Check this out!&body=<?php echo esc_url( get_the_permalink() ) ?>" target="_blank">
                    <div class="bg-ico" id="envelope"><i class="fab fa-envelope social  envelope fa-3x"></i></div>
                </a>
			<?php } ?>

			<?php if ( in_array( 'facebook', $permitted_links ) ) { ?>
                <a class="icon weixin" href="https://share.wechat.com/cgi-bin/share?url=<?php echo esc_url( get_the_permalink() ) ?>" target="_blank" onclick="return openPopup(this.href)">
                    <div class="bg-ico" id="weixin"><i class="fab fa-weixin social  weixin fa-3x"></i></div>
                </a>
			<?php } ?>
