        ...
        <div class="ssp-template-container">
            <div class="ssp-template-icons">
                    ...
                    onclick="return openPopup(this.href)">
                        <img src="<?php echo esc_url(SSPP_PLUGIN_URI . '/assets/images/facebook.png') ?>" alt="Share on Facebook">
                    </a>
                <?php }
                if ( in_array( 'twitter', $permitted_links ) ) {?>
                    ...
                    target="_blank" onclick="return openPopup(this.href)">
                        <img src="<?php echo esc_url(SSPP_PLUGIN_URI . '/assets/images/twitter.png') ?>" alt="Share on Twitter">
                    </a>
                <?php }
                    ...
                    onclick="return openPopup(this.href)">
                        <img src="<?php echo esc_url(SSPP_PLUGIN_URI . '/assets/images/linkedin.png') ?>" alt="Share on LinkedIn">
                    </a>
                <?php }
                    ...
                    onclick="return openPopup(this.href)">
                        <img src="<?php echo esc_url(SSPP_PLUGIN_URI . '/assets/images/whatsapp.png' ) ?>" alt="Share on WhatsApp">
                    </a>
                <?php }?>
            </div>
